        ...
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[470px] h-[328px] bg-[#F8FAFC] p-6 flex flex-col justify-between rounded-3xl">
          <div className="w-full flex flex-col gap-3 items-center">
            ...
            <p className="text-center text-lg font-medium tracking-tighter leading-5 font-inter">
              Are you sure you want to proceed <br /> the transaction with this
              payment method?
            </p>
            <p className="text-center text-lg font-medium tracking-tighter leading-5 font-inter flex">
               
               {mode}
            </p>
          </div>
          <form onSubmit={handleReciveTransaction} className="flex justify-between items-center">
            <ButtonGroup
              name={"Cancel"}
              color={"bg-[#F8FAFC]"}
