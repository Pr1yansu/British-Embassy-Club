...
const OperatorResetPass = () => {
  return (
    <div className="hero-background relative h-screen bg-cover bg-center px-20 grid grid-rows-12 grid-cols-12 gap-4 ">
      <img
        src={elipes1}
        alt="background"
      ...
      {/* Input starts here */}
      <div className="grid items-center justify-center row-start-4 row-end-10 col-start-5 col-end-9 ">
      ...
      <p
        className="text-text_primary font-bold row-start-11 row-end-12 col-start-6 col-end-9"
      >
